    ...
    <div className="space-y-4 text-sm">
      ...
      <div className="border-l-4 border-blue-500 pl-4">
        ...
        <div className="space-y-1 text-white/80">
          ...
          {decoded?.action_type === 'contract_call' && (
            <>
              <div className="border-t border-white/10 my-2 pt-2">
                <div className="text-white/60 text-xs mb-1">Contract Call Details:</div>
              </div>
              {decoded.details?.method_selector && (
                <div className="flex justify-between">
                  <span className="text-white/60">Method Selector:</span>
      ...
      {pbsRelay ? (
        <div className="border-l-4 border-orange-500 pl-4">
          ...
          <div className="space-y-1 text-white/80">
            ...
            {pbsRelay.relay && (
              <div className="flex justify-between">
                <span className="text-white/60">Relay:</span>
        ...
        <div className="border-l-4 border-orange-500/50 pl-4">
          <h3 className="font-semibold text-white/60 mb-2 flex items-center gap-2">
            🔄 Relay Bidtraces
          </h3>
      ...
      {beacon ? (
        <div className="border-l-4 border-cyan-500 pl-4">
          ...
          <div className="space-y-2 text-white/80">
            <div className="flex justify-between">
              <span className="text-white/60">Consensus Slot:</span>
              <span className="font-medium">{beacon.slot?.toLocaleString() || 'N/A'}</span>
            </div>
            {beacon.finalized_epoch !== undefined && (
              <div className="flex justify-between">
                <span className="text-white/60">Finalized Epoch:</span>
              ...
              <div className="mt-2 p-2 rounded border" style={{
                ...
                {beacon.is_finalized ? (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-white/80 text-xs">(Irreversible under normal conditions)</span>
                  </div>
                ) : (
                  <div className="flex items-center gap-2">
                    <span className="text-yellow-400">⏳</span>
                    <span className="font-semibold text-yellow-400">PENDING FINALITY</span>
                    <span className="text-white/80 text-xs">(Waiting for checkpoint finalization)</span>
                  </div>
                )}
              </div>
            )}
