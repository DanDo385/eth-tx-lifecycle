export default function PrePbsVsPbsDiagram() {
  return (
    <section className="rounded-2xl border border-line/10 bg-fill-subtle/5 p-4 md:p-5">
      <h3 className="text-xl font-semibold text-fg">Before PBS vs with PBS/MEV-Boost</h3>
      ...
      <div className="mt-4 grid gap-4 md:grid-cols-2">
        <article className="rounded-xl border border-red-400/25 bg-red-500/5 p-4">
          ...
          <div className="mt-3 rounded border border-red-300/25 bg-surface/20 p-2 text-xs text-red-100">
        ...
        <article className="rounded-xl border border-green-400/25 bg-green-500/5 p-4">
          ...
          <div className="mt-3 rounded border border-green-300/25 bg-surface/20 p-2 text-xs text-green-100">
